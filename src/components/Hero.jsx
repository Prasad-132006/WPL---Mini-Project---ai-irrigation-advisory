...
const Hero = () => {
  return (
    <section className="relative min-h-175 overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto min-h-175 px-6 py-20 lg:py-0 flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-12">
        {/* LEFT */}
        <div className="max-w-2xl text-center lg:text-left text-white">
          <span className="inline-flex items-center gap-1.5 bg-green-600/20 border border-green-400 text-green-300 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-medium mb-5 sm:mb-6 whitespace-nowrap">
          ...
          <p className="mt-8 text-lg text-slate-200 leading-8 max-w-xl">
            Use Artificial Intelligence, weather forecasting, and soil moisture
            analytics to optimize irrigation, reduce water wastage, and maximize
            crop yield.
          </p>
          ...
          <div className="flex flex-wrap gap-8 mt-14">
            <div>
              ...
              <p className="text-slate-300">Farmers Supported</p>
            </div>

            <div>
              <h2 className="text-3xl font-bold">40%</h2>
              <p className="text-slate-300">Water Saved</p>
            </div>
        ...
        <div className="hidden lg:flex relative w-130 h-130">
          ...
          <div className="absolute right-0 top-16 bg-white rounded-3xl shadow-2xl p-6 w-90">
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <h3 className="text-xl font-bold mt-1">Irrigate Tomorrow</h3>
              </div>

              <BrainCircuit className="text-green-600" size={34} />
            </div>
          ...
          <div className="absolute left-0 top-0 bg-white rounded-2xl shadow-xl p-5 w-52">
            <CloudRain className="text-blue-500 mb-3" size={34} />

            <h4 className="font-semibold">Weather Forecast</h4>

            <p className="text-gray-500 mt-2">Rain Tomorrow</p>

            <p className="text-4xl font-bold mt-3">78%</p>
          </div>

          {/* Soil Card */}

          <div className="absolute left-12 bottom-12 bg-white rounded-2xl shadow-xl p-5 w-56">
            <Droplets className="text-cyan-500 mb-3" size={34} />
